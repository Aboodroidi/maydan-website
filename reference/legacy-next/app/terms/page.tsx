...
export const metadata: Metadata = {
  title: "Terms of Use — Maydan",
  description: "The terms that govern your use of Maydan.",
};
...
export default function TermsPage() {
  return (
    <LegalShell title="Terms of Use" updated="July 2026">
      ...
      <ul>
        <li><strong>More than 24 hours</strong> before the start time: free cancellation, refunded to your original payment method (typically within 2–10 days).</li>
